...
| ---------------------------- | --------------- | ---------------------------------------------------------------- | ------------------ |
| Dịch vụ Bảo hành             | Task Service    | Xử lý việc đăng ký và xác thực điều kiện bảo hành                | Spring Boot, MySQL |
| Dịch vụ Khách hàng           | Entity Service  | Quản lý thông tin khách hàng, bao gồm lịch sử mua và bảo hành    | Spring Boot, MySQL |
| Dịch vụ Sản phẩm             | Entity Service  | Quản lý sản phẩm, bao gồm số serial và thời hạn bảo hành         | Spring Boot, MySQL |
| Dịch vụ Kỹ thuật viên        | Entity Service  | Quản lý thông tin về các kỹ thuật viên phụ trách kiểm tra        | Spring Boot, MySQL |
| Dịch vụ Khảo sát             | Entity Service  | Thu thập phản hồi từ khách hàng về chất lượng dịch vụ bảo hành   | Spring Boot, MySQL |
| Dịch vụ Sửa chữa             | Entity Service  | Theo dõi tiến độ sửa chữa sản phẩm, cập nhật trạng thái          | Spring Boot, MySQL |
| Dịch vụ Điều kiện Bảo hành   | Micro Service   | Quản lý điều kiện bảo hành và xác thực yêu cầu                   | Spring Boot, MySQL |
| Dịch vụ Thông báo            | Utility Service | Gửi thông báo cho khách hàng và nhân viên                        | Spring Boot, MySQL |
| API Gateway                  | Infrastructure  | Định tuyến các yêu cầu API và xác thực JWT                       | Spring Cloud Gateway |
| Dịch vụ Bảo mật              | Infrastructure  | Quản lý xác thực và phân quyền                                   | Spring Boot, JWT   |
...
- Gateway ⇄ Dịch vụ Bảo mật (REST): Xác thực token và phân quyền
- Gateway ⇄ Tất cả Dịch vụ (REST): Định tuyến các request đến dịch vụ tương ứng

### 3.2. Giao tiếp Đồng bộ (REST API)
- Dịch vụ Bảo hành ⇄ Dịch vụ Khách hàng: Lấy thông tin khách hàng và lịch sử yêu cầu
- Dịch vụ Bảo hành ⇄ Dịch vụ Sản phẩm: Xác minh thông tin sản phẩm và thời hạn bảo hành
- Dịch vụ Bảo hành ⇄ Dịch vụ Sửa chữa: Tạo yêu cầu sửa chữa và cập nhật tiến độ
- Dịch vụ Bảo hành ⇄ Dịch vụ Kỹ thuật viên: Lấy thông tin kỹ thuật viên cho công việc sửa chữa
- Dịch vụ Bảo hành ⇄ Dịch vụ Điều kiện Bảo hành: Xác thực điều kiện bảo hành
- Dịch vụ Sửa chữa ⇄ Dịch vụ Kỹ thuật viên: Phân công kỹ thuật viên
- Dịch vụ Khách hàng ⇄ Dịch vụ Sản phẩm: Lấy thông tin sản phẩm đã mua

### 3.3. Giao tiếp Bất đồng bộ (Kafka)
- Dịch vụ Bảo hành → Dịch vụ Thông báo: Gửi thông báo về trạng thái bảo hành qua topic "warranty-notifications"
- Dịch vụ Sửa chữa → Dịch vụ Thông báo: Gửi thông báo về tiến độ sửa chữa
- Dịch vụ Sửa chữa → Dịch vụ Bảo hành: Cập nhật trạng thái sửa chữa lên bảo hành
...
### 4.8. DỊCH VỤ ĐIỀU KIỆN BẢO HÀNH
...
1. **Khả năng mở rộng độc lập**: Mỗi dịch vụ có thể được mở rộng dựa trên nhu cầu riêng. Ví dụ, Dịch vụ Sửa chữa có thể cần nhiều tài nguyên hơn trong thời gian cao điểm của mùa bảo hành.
...
3. **Khả năng chịu lỗi**: Nếu một dịch vụ gặp sự cố, hệ thống vẫn có thể hoạt động một phần. Ví dụ, nếu Dịch vụ Khảo sát gặp sự cố, khách hàng vẫn có thể gửi yêu cầu bảo hành.
